    ...
    <>
      ...
      <nav className="sticky top-0 z-50 bg-background border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <a
            href="#contato"
            className="hidden sm:inline-flex items-center px-4 py-2 text-sm font-medium text-foreground bg-brand rounded-lg hover:bg-brand-hover transition-colors"
          >
      ...
      <section className="py-20 sm:py-28 lg:py-36 px-4 bg-surface">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground leading-tight tracking-tight">
            O formulário de personalidade que prepara suas clientes antes de
            cada sessão
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#contato"
              className="inline-flex items-center px-8 py-4 text-base font-semibold text-foreground bg-brand rounded-xl hover:bg-brand-hover transition-colors shadow-lg shadow-brand/25"
            >
              Quero meu formulário
            </a>
            <a
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-5">
            {[
              ...
              <div key={item} className="flex items-start gap-3">
                <span className="mt-0.5 flex-shrink-0 text-brand font-bold">
                  ✓
                </span>
      ...
      {/* CTA / Contato */}
      <section id="contato" className="py-20 sm:py-24 px-4 bg-cta-bg">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center px-10 py-4 text-lg font-semibold text-foreground bg-brand rounded-xl hover:bg-brand-hover transition-colors shadow-lg"
          >
            Falar no WhatsApp
          </a>
        </div>
      ...
      <footer className="py-8 px-4 bg-footer-bg text-center">
        <p className="text-sm text-muted-foreground">&copy; 2025 Strutura AI</p>
      </footer>
    </>
  );
}
