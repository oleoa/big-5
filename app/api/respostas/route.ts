...
// A geração do relatório corre em background (after) e pode demorar ~20-40s.
...
export async function POST(req: NextRequest) {
  ...
  // Campos extras, indexados pelo label da pergunta (consumido por buildParte1).
  ...
  // Gera o relatório (Parte 1 + análise IA + email) em background.
